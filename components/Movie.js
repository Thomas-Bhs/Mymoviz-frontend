...
function Movie(props) {
  ...
  const maxLength = 100;
  const shortOverview = props.overview.length > maxLength ? props.overview.substring(0,maxLength) + '...' : props.overview;

  // dans image rajout du préfixe de l'url car l'APi nous renvoi que la fin
  return (
